...
class Retina:
    def __init__(self, action='none', debug=False):
		...
		"""
        IPython.core.display.display_javascript(IPython.core.display.Javascript(data=src, lib=rlibs, css=rcss))

    def graph(self, width=800, height=400, btype="column", target="target", data="null", title="Browser Usage", x_labels="['2005','2006','2007','2008']", x_title="Year", y_title="Percentage", show_legend=False, legend_position='left', title_color="black", x_title_color="black", y_title_color="black", x_labels_rotation="0", x_tick_interval=0, y_tick_interval=30, x_labeled_tick_interval=1, y_labeled_tick_interval=5, default_line_color="black", default_line_width=1, chartArea="null", legendArea="null", onclick="clickedCell"):
	"""Graph Renderer
